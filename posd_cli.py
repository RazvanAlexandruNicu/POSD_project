...
if cmd == 'list_artifacts':
    ...
    print("upload_artifact [artifact_name] - Upload a new approved artifact. This will give instant access to it for all Engineering department members")
    print("delete_artifact [artifact_name] - Delete an existing approved artifact. This will instantly remove access to it for all Engineering department members")
    print("list_announcements - List all public anouncements in the company")
    print("insert_announcement [announcement] [date] - Publish a public announcement for all company members. This will send an email to all the subscribed employees")
    print("add_user_to_department [user_name] [department_name] - Administrator only. Add a user to an existing department. Available department options: [HumanResourcesDepartment, EngineeringDepartment, SupportEngineeringDepartment]")
    print("delete_user_from_department [user_name] [department_name] - Administrator only. Remove a user from an existing department. Available department options: [HumanResourcesDepartment, EngineeringDepartment, SupportEngineeringDepartment]")
else:
